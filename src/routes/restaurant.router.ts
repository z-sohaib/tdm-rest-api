...
router.post("/restaurants", checkLogs, isLoggedIn, RestaurantController.createRestaurant);
router.get("/restaurants", checkLogs,  RestaurantController.getAllRestaurants);
router.get("/restaurants/:id", checkLogs, isLoggedIn, RestaurantController.getRestaurantById);
router.put("/restaurants/:id", checkLogs, isLoggedIn, RestaurantController.updateRestaurant);
router.delete("/restaurants/:id", checkLogs, isLoggedIn, isAdmin, RestaurantController.deleteRestaurant);
