...
export class RestaurantController {
    ...
    static createRestaurant = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
        try {
    ...
    static getAllRestaurants = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
        try {
    ...
    static getRestaurantById = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
        try {
    ...
    static updateRestaurant = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
        try {
    ...
    static deleteRestaurant = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
        try {
