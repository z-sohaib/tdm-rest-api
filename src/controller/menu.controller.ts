...
export class MenuController {
  static addMenuItem = async (
    ...
    try {
      ...
      for (const itemData of menuItems) {
        const menuItemData = {
          ...itemData,
          imageUrl: itemData.fileUrl, // Use the uploaded file URL from Cloudinary
        };
        const menuItem = await MenuService.addItem(restaurantId, menuItemData);
  ...
  static getMenuById = async (
    ...
    try {
      ...
      Logger.error(
        "Error fetching menu item by ID",
